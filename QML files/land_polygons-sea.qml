      ...
      <symbols>
        <symbol name="0" clip_to_extent="1" type="fill" force_rhr="0" alpha="1">
          <layer enabled="1" locked="0" pass="0" class="ShapeburstFill">
            <prop v="15" k="blur_radius"/>
            <prop v="184,217,247,255" k="color"/>
            <prop v="211,230,247,255" k="color1"/>
            <prop v="118,171,207,255" k="color2"/>
            <prop v="1" k="color_type"/>
            <prop v="0" k="discrete"/>
            <prop v="3x:0,0,0,0,0,0" k="distance_map_unit_scale"/>
            <prop v="MM" k="distance_unit"/>
            <prop v="101,150,193,255" k="gradient_color2"/>
            <prop v="0" k="ignore_rings"/>
            <prop v="50" k="max_distance"/>
            <prop v="0,0" k="offset"/>
            <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
            <prop v="MM" k="offset_unit"/>
            <prop v="gradient" k="rampType"/>
            <prop v="0.103175;211,230,247,255" k="stops"/>
