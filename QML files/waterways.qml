...
<qgis version="2.14.3-Essen" minimumScale="0" maximumScale="1e+06" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{9716a709-e494-4815-9eda-5a35f66b8a84}">
      <rule filter="fclass IN ('river', 'stream', 'canal')" key="{86e9bda0-862a-4865-b4ed-e79749096aef}" symbol="0" label="main river"/>
      <rule filter="fclass NOT IN ('river', 'stream', 'canal')" key="{1db40ed8-4a1b-48b5-9606-084bea9d7e81}" symbol="1" label="small river"/>
    </rules>
    <symbols>
