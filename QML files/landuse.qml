...
<qgis version="2.14.3-Essen" minimumScale="-4.65661e-10" maximumScale="500100" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{a12fd7d2-701b-4db9-9d3d-2b2f138ae7b4}">
      <rule filter="&quot;fclass&quot; = 'residential'" key="{0f8117c1-80a1-44f1-a35a-6b4e4723917f}" symbol="0" label="residential"/>
      <rule filter="&quot;fclass&quot;IN ('allotments', 'farm', 'farmland', 'farmyard')" key="{c84b7500-c151-47f7-b75a-4f746c24e1e3}" symbol="1" label="allotments, farm, farmland, farmyard"/>
      <rule filter="&quot;fclass&quot; IN ( 'cemetery', 'grave_yard')" key="{6d279cdd-531b-4370-a4bf-97f6d51e5340}" symbol="2" label="cemetery"/>
      <rule filter="&quot;fclass&quot; IN ('retail')" key="{12852c14-05b9-4bdc-be32-66bffe62ae4c}" symbol="3" label="Retail"/>
      <rule filter="&quot;fclass&quot; IN ('industrial')" key="{aa341c78-d199-40cb-a709-8c81f1599da8}" symbol="4" label="Industrial"/>
      <rule filter="&quot;fclass&quot; IN ('commercial')" key="{3ff562b2-cabc-40e9-aac0-3376f234ea75}" symbol="5" label="Commercial"/>
      <rule filter="&quot;fclass&quot; = 'conservation'" key="{519d8c4a-097f-4855-bac3-d24469ea4dab}" symbol="6" label="conservation"/>
      <rule filter="&quot;fclass&quot; IN( 'grass', 'grassland', 'village_green', 'park')" key="{712996fb-2621-4600-a83d-61badbdd8ac3}" symbol="7" label="grass, grassland, village green, park"/>
      <rule filter="&quot;fclass&quot; = 'greenhouse_horticulture'" key="{290a0491-bfa0-4d9c-a7fc-fa31558b5c0e}" symbol="8" label="greenhouse horticulture"/>
      <rule filter="&quot;fclass&quot; = 'meadow'" key="{aee59aba-7abd-4e73-be02-4a5203978193}" symbol="9" label="meadow"/>
      <rule filter="&quot;fclass&quot; = 'military'" key="{9c67eaf2-3b8d-410e-878e-d19a52a21aff}" symbol="10" label="military"/>
      <rule filter="&quot;fclass&quot; = 'orchard'" key="{f4f32f17-587f-4046-b64c-2ccbdd1f1642}" symbol="11" label="orchard"/>
      <rule filter="&quot;fclass&quot; = 'vineyard'" key="{952b368a-1971-4335-b266-aebf4ebee4ae}" symbol="12" label="vineyard"/>
      <rule filter="&quot;fclass&quot; = 'quarry'" key="{49ed7e3b-00f9-4cf1-9dff-dcfba94446b6}" symbol="13" label="quarry"/>
      <rule filter="&quot;fclass&quot; = 'landfill'" key="{218e5359-c032-4698-84e2-88f8391d122c}" symbol="14" label="landfill"/>
      <rule filter="&quot;fclass&quot; = 'recreation_ground'" key="{fffcbb65-6a4a-4e17-a4d9-8a7ce0690b9a}" symbol="15" label="recreation ground"/>
      <rule filter="&quot;fclass&quot; IN ('school', 'education')" key="{b7bc9935-bde1-4fa3-9dcf-6921c40678d9}" symbol="16" label="school, education"/>
      <rule filter="&quot;fclass&quot; IN ('wood', 'forest')" key="{a0bb679f-9639-4864-8047-db50a9398378}" symbol="17" label="wood, forest"/>
      <rule filter="&quot;fclass&quot;IN ('aquaculture', 'basin', 'reservoir', 'pool')" key="{04332344-e5d5-442c-8e23-81df65e2a8bc}" symbol="18" label="aquaculture, basin, reservoir, pool"/>
      <rule filter="&quot;fclass&quot; = 'salt_pond'" key="{c99dc9dd-7891-469e-8f5a-c86da9deaf9c}" symbol="19" label="salt pond"/>
      <rule filter="&quot;fclass&quot; = 'harbour'" key="{3d733130-77b5-4c34-8310-f00308b99a3f}" symbol="20" label="harbour"/>
      <rule filter="&quot;fclass&quot;  =  'pitch'" key="{ce389fb2-d2af-4905-b8d2-c1162689937d}" symbol="21" label="pitch"/>
    </rules>
    <symbols>
