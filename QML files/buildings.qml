...
<qgis version="2.14.3-Essen" minimumScale="0" maximumScale="5000" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{8d88bf69-a2f9-4ba0-a01d-a84feb5fec2e}">
      <rule key="{6ec7b23b-30e4-4294-926f-b7d1f709db09}" symbol="0" label="Building"/>
      <rule scalemaxdenom="5000" key="{573c16b0-a5e1-450d-9915-35107bd07385}" symbol="1" label="Shadow 1"/>
      <rule scalemaxdenom="5000" key="{0adab446-1f64-4139-9e14-4858947dd47e}" symbol="2" label="Shadow 2"/>
      <rule scalemaxdenom="5000" key="{86556dcb-2f4d-4733-a206-2c74d7af4c9d}" symbol="3" label="Shadow 3"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="0.741176" clip_to_extent="1" type="fill" name="2">
